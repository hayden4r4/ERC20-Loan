...
contract loan {
    ...
    */
        ...
        */
        ...
        if (terms.prepayment_penalty > 0) {
            ...
            if (
                ...
                if (payment > balances.outstanding_balance) {
                    revert("payment is larger than outstanding balance");
                }
            } else if (
                (terms.issuance_time + terms.prepayment_period) > current_time
            ) {
    ...
    function freeCollateral() public payable onlyBorrower {
        ...
        if (balances.outstanding_balance <= 0) {
            (bool sent, bytes memory data) = terms.lender.call{
            ...
            revert("Cannot free collateral while outstanding balance > 0");
        }
    }
